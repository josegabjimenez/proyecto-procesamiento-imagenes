...
if images != []:
    ...
    # Segmentación Final
    # ----------------------------------------------------------------------------------
    st.markdown("## Segmentación Final")

    # Crear dos columnas, en una se muestra un input para seleccionar un número que representa el label de las lesiones y abajo un botón para quitar el cráneo y en la otra columna se muestra la imagen final
    col1, col2 = st.columns(2)

    with col1:
        lession_label = st.number_input(
            "Selecciona un label de la FLAIR segmentada para las lesiones",
            min_value=0,
            max_value=100,
            step=1,
            value=2,
        ...
        # Remove brain
        remove_brain_button = st.button("Quitar el craneo y segmentar lesiones")
        ...
        st.download_button(
            label="Descargar Imagen Final Segmentada",
            data=nii_data,
    ...
    with col2:
        ...
        if remove_brain_button:
            final_image = remove_brain(lession_label)
